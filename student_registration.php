...
<body>
	...
	<div class="fac-form">
		...
		<div class="reg-form">
			...
			<input type="text" name="id" value="" placeholder="Student ID Number" pattern="^[0-9]+$" required>
			</div>

			<div class="input-group">
			<label>Name</label>
			<input type="text" name="name" value="" placeholder="Student Name" pattern="([^0-9]*)$" required>
			</div>
			...
			<br><center>  
			<div class="input-group">
			<button type="submit" class="btn" name="stu_reg" id="reg-btn">Register</button>
			</div>
			<br>
